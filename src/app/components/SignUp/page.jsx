...
const SignUp = () => {
  ...
  return (
    <div className="siteContent">
      <Breadcrumb titlePage="Sign up" color="#212529" />
      <Container>
        <div className={`${styles.contentSignUp}  ${styles.signUp}`}>
          ...
          <Form onSubmit={formik.handleSubmit}>
            ...
            <Form.Group className={styles.checkRemember}>
              <span>
                In compliance with current regulations on Personal Data Protection
                Act 2012 (&ldquo;PDPA 2012&rdquo;), we inform you that the data that
                you incorporate will be treated by with the purpose to manage your
